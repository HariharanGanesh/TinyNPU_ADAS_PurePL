...
REM
REM Generated by Vivado on Thu Aug 06 14:17:44 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tinynpu_system_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tinynpu_system_tb_vlog.prj -log xvlog.log
