...
#ifndef _tinynpu_system_bd_concat_status_0_core_h_
#define _tinynpu_system_bd_concat_status_0_core_h_
...
class tinynpu_system_bd_concat_status_0_core : public sc_module 
{
    public: 
       tinynpu_system_bd_concat_status_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(tinynpu_system_bd_concat_status_0_core);
    ...
    virtual ~tinynpu_system_bd_concat_status_0_core() = default;
