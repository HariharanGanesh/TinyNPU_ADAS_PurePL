...
if {$post_wns >= 0.0} {
    ...
    puts "==================================================="
    write_bitstream -force {D:/Final year project/Vivado/tinynpu_pynq_system_project/tinynpu_pynq_system/tinynpu_pynq_system.runs/impl_1/tinynpu_system_bd_wrapper.bit}
